...
# compare "a" file 
setenv ORIG_FILE $DATADIR/beld3.${grid}_output_a.ncf
...
if($status != 0) then
  echo "ERROR comparing beld3.${grid}_output_a.ncf files."
  set eflag = 1
endif

# compare "b" file
setenv ORIG_FILE $DATADIR/beld3.${grid}_output_b.ncf
...
# compare "tot" file
setenv ORIG_FILE $DATADIR/beld3.${grid}_output_tot.ncf
...
if($status != 0) then
  echo "ERROR comparing beld3.${grid}_output_tot.ncf files."
  set eflag = 1
endif
