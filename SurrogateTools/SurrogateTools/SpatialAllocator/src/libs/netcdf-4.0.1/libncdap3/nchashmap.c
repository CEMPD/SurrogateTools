 ...
 *   $Header: /upc/share/CVS/netcdf-3/libncdap3/nchashmap.c,v 1.1 2009/03/25 01:48:31 dmh Exp $
 *********************************************************************/
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
NChashmap* nchashnew0(int alloc)
{
  NChashmap* hm;
  if(!initialized) {
    memset((void*)&DATANULL,0,sizeof(ncelem));
    initialized = 1;
  }
...
{
    ncelem value;
    if(!nchashlookup(hm,hash,&value)) return DATANULL;
    return value;
}
