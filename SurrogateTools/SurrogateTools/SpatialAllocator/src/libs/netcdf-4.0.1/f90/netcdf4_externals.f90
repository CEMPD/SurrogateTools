...
! Copyright 2006, UCAR
! $Id: netcdf4_externals.f90,v 1.13 2009/02/23 12:49:19 ed Exp $
  ...
  integer, external :: nf_create_par, nf_open_par, nf_var_par_access, &
       ...
       nf_inq_grpname_len, nf_inq_grp_parent, nf_inq_grp_ncid, nf_inq_varids, &
       ...
       nf_def_enum, nf_insert_enum, nf_inq_enum, nf_inq_enum_member, nf_inq_enum_ident, &
