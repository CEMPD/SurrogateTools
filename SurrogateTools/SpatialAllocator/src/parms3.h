...
C
C    VERSION "@(#)$Header: /cvsroot/mimsfw/SurrogateTools/SpatialAllocator/src/parms3.h,v 1.2 2008/01/25 21:33:18 eyth Exp $"
...
#define   LAMGRD3    (2)  
                          /*  grid type value:  Mercator 1SP coords        */
#define   MER1GRD3   (3)  
                          /*  grid type value:  Mercator 2SP coords        */
#define   MER2GRD3   (4)
...
#define   LAEAGRD3   (9)
                          /*  grid type value:  Albers Equal-Area Conic*/
#define   AEAGRD3    (10)
