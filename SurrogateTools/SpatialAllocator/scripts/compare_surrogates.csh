...
# Set grid name
set grid = M_08_99NASH  # state for running surrogates

# Location of executable
set EXE = $BASDIR/diffsurr.exe

setenv NEW_SRGS  $BASDIR/output/srg_${grid}.txt    # new merged surrogate file 
setenv REFERENCE_SRGS  $BASDIR/data/srg_nash_ref.txt   # reference surrogates
