 ...
 *   $Header: /upc/share/CVS/netcdf-3/ncgen4/generr.c,v 1.4 2009/03/11 18:26:17 dmh Exp $
 *********************************************************************/
...
/* Report panic errors (those that should never happen) */
#ifndef NO_STDARG
int panic(const char *fmt, ...)
#else
int panic(fmt,va_alist) const char* fmt; va_dcl
#endif
{
    va_list argv;
    vastart(argv,fmt);
