...
#define DEBUG(l,msg) if(ocdebug >= l) {oclog(LOGDBG,msg);} else {}
#define DEBUG1(l,msg,arg) if(ocdebug >= l) {oclog(LOGDBG,msg,arg1);} else {}
#define DEBUG2(l,msg,arg1,arg2) if(ocdebug >= l) {oclog(LOGDBG,msg,arg1,arg2);} else {}
#define DEBUGTEXT(l,text) if(ocdebug >= l) {oclogtext(text);} else {}
