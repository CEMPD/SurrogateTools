...
#
#set MODIS L2 cloud product file directory which containts each day data:
#  
#setenv DATA_DIR   "../data/sat/MYD06_L2_062006/"

#Set SDS variables to be extracted
#
#setenv SATELLITE_VARIABLE Cloud_Fraction,Cloud_Top_Pressure_Infrared,Cloud_Optical_Thickness
#

#
#set MODIS L2 aerosol product file directory which containts each day data:
# 
setenv DATA_DIR   "../data/sat/MYD04_L2_062006/"
